% function [ ftp,ffp,detectornum,selfdetectornum] = NSALab()
...
aa=20*Rs;
if shape==1
    selfsample=fivecirclesample(selfnum,0);
elseif shape==2
    selfsample=Trianglesample(selfnum,0);
elseif shape==3
    selfsample=incrosssample(selfnum,0);
elseif shape==4
    selfsample=starsample(selfnum,0);
elseif shape==5
    selfsample=stripesample(selfnum,0);
elseif shape==6
    selfsample=crosssample(selfnum,0);
elseif shape==7
    selfsample=singleTrianglesample(selfnum,0);
elseif shape==8
    selfsample=singlestarsample(selfnum,0);
end
